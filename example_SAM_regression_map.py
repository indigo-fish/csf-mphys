...
start_year,end_year = 1958,2020 # choose the period over which to calculate regression pattern
...
zg2,_,_,_,times2,_,_ = reading_in_data_functions.read_in_variable(file_str_ERA5_2,'zg',chosen_level=500) # weirdly, these two files use different variable names zg vs geopotential_height
