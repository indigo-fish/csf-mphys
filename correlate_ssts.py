...
def make_corr_map(dataset, season, variable='sst'):
	...
	if variable=='sst' or variable=='tos':
		dataset_file = '/home/p/pattersonm/sst_ecmf-guh4_1101_fcmean_sfc_1901_2010_' + season  + '.nc' #CSF mean data was generated by Matt using CDO
		...
		ds_var, ds_lats, ds_lons, ds_levs, ds_times, ds_calendar, ds_t_units = reading_in_data_functions.read_in_variable(dataset_file, 'Geopotential')
		era_file = '/network/group/aopp/met_data/MET001_ERA5/data/zg/mon/zg_mon_ERA5_1x1_195001-197812.nc'
		era_var, era_lats, era_lons, era_levs, era_times, era_calendar, era_t_units = reading_in_data_functions.read_in_variable(era_file, 'zg', chosen_level=500)
		era_file2 = '/network/group/aopp/met_data/MET001_ERA5/data/zg/mon/zg_mon_ERA5_1x1_197901-202012.nc'
	...
	#save figure
	figure_name = Figure_dir + variable + '_correlations_CSF-20C_ERA_DJF_' + str(start_year) + '-' + str(end_year) + '.png'
